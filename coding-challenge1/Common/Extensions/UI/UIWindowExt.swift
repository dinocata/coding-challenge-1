    ...
    struct TransitionOptions {
        ...
        public enum Curve {
            ...
            internal var function: CAMediaTimingFunction {
                ...
                switch self {
                case .linear:       key = .linear
                case .easeIn:       key = .easeIn
                case .easeOut:      key = .easeOut
                case .easeInOut:    key = .easeInEaseOut
                }
        ...
        public var duration: TimeInterval = 0.30
        
        /// Direction of the transition (default is `toRight`)
        public var direction: TransitionOptions.Direction = .toRight
        
        /// Style of the transition (default is `easeInOut`)
        public var style: TransitionOptions.Curve = .easeInOut
        
        /// Background of the transition (default is `nil`)
        public var background: TransitionOptions.Background? = .solidColor(.white)
